        ...
        if(activeTab === 0) {
            return(
                <div className="projects-grid">
                    <Card shadow={5} style={{minWidth: '450', margin: 'auto'}}>
                        ...
                        <CardActions border >
                            <a href="https://github.com/bishop254" rel="noopener noreferrer" target="_blank"><Button colored>Github</Button></a>
                        </CardActions>
            ...
            return(
                <Card shadow={5} style={{minWidth: '450', margin: 'auto'}}>
                    ...
                    <CardActions border>
                        <a href="https://github.com/bishop254/pushup" rel="noopener noreferrer" target="_blank"><Button colored>Github</Button></a>
                    </CardActions>
                    <CardMenu style={{color: 'black '}}>
                        <IconButton name="share"/>
                    </CardMenu>
